...
=== FILE 2tnsram_simple.asc (1419 chars) ===
```
Version 4
SHEET 1 3052 680
WIRE 800 0 512 0
...
=== FILE artifacts/A1a_nfactor_trace.md ===
```
...
=== FILE artifacts/A1b_bjt_mapping.md ===
```
...
=== FILE artifacts/A1c_body_diode_trace.md ===
```
...
=== FILE artifacts/A1d_iimpact_trace.md ===
```
...
=== FILE artifacts/A1e_gidl_load_trace.md ===
```
...
=== FILE artifacts/A1g_multiroot.md ===
```
...
=== FILE artifacts/A1h_iimod_audit.md ===
```
...
=== FILE artifacts/A1i_complementary_bipolar.md ===
```
...
=== FILE O2_packet.zip::2Tcell_BSIM_param_DC.csv ===
```
VG1,VG2,trise,ETAB,K1,ALPHA0,BETA0,NFACTOR,mbjt,IS,area
0.2,-0.2,11.63,0.8,0.55825,7.842e-05,10.75,12.15,0.001,5e-09,1e-06
0.2,-0.15,11.63,0.85,0.55825,7.842e-05,11,11.15,0.001,5e-09,1e-06
...
=== FILE O2_packet.zip::2tnsram_simple.asc ===
```
Version 4
SHEET 1 3052 680
WIRE 800 0 512 0
...
=== FILE O2_packet.zip::M1_130DNWFB.txt ===
```
* Predictive Technology Model Beta Version
* 130nm NMOS SPICE Parametersv (normal one)
*  http://ptm.asu.edu/latest.html\
...
=== FILE O2_packet.zip::M2_130bulkNSRAM.txt ===
```
.param toxn    = 4e-009               toxp    = 4e-009
+lintn   = 1.219e-8             lintp   = -1.079e-8
+vth0n   = 0.54153              vth0p   = -1.106133
...
=== FILE O2_packet.zip::artifacts/A1a_nfactor_trace.md ===
```
# A1a — NFACTOR override trace through compute_dc
...
=== FILE O2_packet.zip::artifacts/A1b_bjt_mapping.md ===
```
# A1b — BJT Parameter Mapping (Sebas CSV ↔ `GummelPoonNPN`)
...
=== FILE O2_packet.zip::artifacts/A1c_body_diode_trace.md ===
```
# A1c — Component-current trace at low-VG2 bias
...
=== FILE O2_packet.zip::artifacts/A1d_iimpact_trace.md ===
```
# A1d — Why is Iii_M2 ≈ 0 at low VG2?
...
=== FILE O2_packet.zip::artifacts/A1e_gidl_load_trace.md ===
```
# A1.e — GIDL/GISL load trace for M2 at (VG1=0.6, VG2=0.0)
...
=== FILE O2_packet.zip::artifacts/A1g_multiroot.md ===
```
# A1g — Multi-root hypothesis at low VG2
...
=== FILE O2_packet.zip::artifacts/A1h_iimod_audit.md ===
```
# A1h — IIMOD audit: does our `compute_iimpact` match Sebas's card?
...
=== FILE O2_packet.zip::artifacts/A1i_complementary_bipolar.md ===
```
# A1i — Decoding Sebas's "Complementary Bipolar Current"
...
=== FILE O2_packet.zip::email_history.md ===
```
# Email history Sebas / Mario / Robert / Eric (extracted from TXT.rtf)
...
=== FILE O2_packet.zip::parasiticBJT.txt ===
```
* Simple bjt for floating bulk parasitic bipolar effect
* Pazos, S.
...
=== FILE O2_packet.zip::summary.json ===
```
{
  "n_curves": 33,
  "n_evaluated": 25,
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/__init__.py ===
```
# bsim4_port/__init__.py — Phase TBD; see docs/bsim4_port_plan.md

```

=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/arclength.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/bjt.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/caps.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/constants.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/dc.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/diode.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/geometry.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/leak.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/model_card.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/nsram_cell.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/nsram_cell_2T.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/smooth.py ===
```
...
=== FILE nsram_bsim4_port.zip::nsram/nsram/bsim4_port/temp.py ===
```
...
=== FILE validation_scripts.zip::z91d_bsim4_port_fit_arclength.py ===
```
...
=== FILE validation_scripts.zip::z91e_bsim4_port_fit_with_anchors.py ===
```
...
=== FILE validation_scripts.zip::z91f_validate_with_sebas_params.py ===
```
...
=== FILE validation_scripts.zip::z91g_two_model_validation.py ===
```
