...
durations). On two AMD Ryzen AI Max+ 395 "Strix Halo" laptops (`hostA`
and `hostB`) we obtain 100% leave-one-out per-die classification
...
290-dim signatures, top-2 components, hostA vs hostB
...
| 2 | Peer transplant | hostB phys read on N | classifier rejects on inter-core TSC + nanosleep p99.9 features |
