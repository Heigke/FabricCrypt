#!/usr/bin/env python3
"""
z2123v15: Thermal Softmax v2 — Tighter Ranges + Stronger Noise
=====================================================================
v15: Fixes z2123v15 regressions (22/40 → target 26+):

  z2122 diagnosis:
  - PULSE_EPS=0.05 was BELOW noise floor (salience sweep showed 0.10 optimal)
  - GATE_TEMP=4.0 too soft → T7 kill-shot=1.004 (needed >1.05)
  - Thermal range [40,90]°C too wide — actual operating range is 42-65°C
  - Noise sigma=0.0001 negligible vs hidden state magnitudes

  v15 fixes:
  1. PULSE_EPS=0.10 (salience sweep optimum from z2122)
  2. GATE_TEMP=6.0 (compromise: sharper than 4.0, not locked like 8.0)
  3. Thermal range [35,75]°C (tighter to actual operating temps)
  4. NOISE_SIGMA_BASE=0.01 (5x stronger — actually perceptible)
  5. NOISE_SIGMA_MAX=0.05 (5x higher ceiling)
  6. Keeps thermal softmax + physical noise from v14
...
Hardware setup:
  ...
  sudo HSA_OVERRIDE_GFX_VERSION=11.0.0 PYTORCH_ROCM_ARCH=gfx1100 \\
    venv/bin/python -u scripts/z2123_thermal_softmax_v15.py
"""
...
PULSE_EPS = 0.10          # v15: salience sweep optimum from z2122 (0.05 was below noise floor)
...
GATE_TEMP = 6.0           # v15: compromise (4.0 too soft for kill-shot, 8.0 too binary)

# v14: Thermal Softmax constants — Boltzmann kT maps die temp to attention temperature
THERMAL_SOFTMAX_T_MIN = 35.0    # °C — v15: tighter to actual operating range (was 40)
THERMAL_SOFTMAX_T_MAX = 75.0    # °C — v15: tighter (was 90, GPU rarely exceeds 65°C)
...
NOISE_SIGMA_BASE = 0.01    # v15: 5x stronger (0.002 was imperceptible)
NOISE_SIGMA_MAX = 0.05     # v15: 5x higher ceiling (0.01 never reached)
...
def run_phase_b(model, train_data, test_data, test_data_code, baseline_ppl, phase_a_results):
    ...
    print("  v15: thermal softmax + stronger noise + PULSE_EPS=0.10 + GATE_TEMP=6.0")
    print("=" * 60)
...
def main():
    ...
    print("=" * 60)
    print("z2123v15: Thermal Softmax + Physical Noise — Silicon Shapes Attention")
    ...
    print(f"\n" + "=" * 60)
    print(f"z2123v15 Thermal Softmax GPT-2 LM: {n_pass}/{n_total} PASS")
    print("=" * 60)

    # Save results
    out_path = os.path.join(os.path.dirname(__file__), '..', 'results', 'z2123_thermal_softmax.json')
    out_path = os.path.abspath(out_path)
    result_obj = {
        'experiment': 'z2123v15_thermal_softmax',
        'description': (
            ...
            'PULSE_EPS=0.10, GATE_TEMP=6.0, thermal range [35,75]°C, noise 5x stronger.'
