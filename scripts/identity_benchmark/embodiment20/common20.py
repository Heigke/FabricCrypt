"""Phase 20 common helpers (same conservative thermal as Phase 19)."""
import os, sys, time, json, socket, subprocess, glob
...
def find_hwmon(name_match):
    """Return hwmonN path whose name file matches substring."""
