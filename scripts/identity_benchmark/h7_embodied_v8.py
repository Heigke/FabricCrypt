...
OUT = ROOT / "results/IDENTITY_EMBODIED_V8_2026-06-10"
OUT.mkdir(parents=True, exist_ok=True)
LOG = OUT / f"v8_{HOST}.jsonl"
CKPT = OUT / f"v8_{HOST}.pt"
BEST_CKPT = OUT / f"v8_best_{HOST}.pt"
...
def main():
    ...
    print(f"[v8 FiLM] host={HOST} device={device} steps={args.steps} M_dep={M_DEP} cap={DEP_CAP}")
    ...
    for step in range(args.steps):
        ...
        if step > 0 and step % EVAL_EVERY == 0:
            ...
            blob = {"step": step, "host": HOST, "version": "v8",
