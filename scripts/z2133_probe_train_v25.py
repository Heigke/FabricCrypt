#!/usr/bin/env python3
"""
z2133v25: Probe Train — v23 Base + Dedicated SomaProbe Training
===============================================================
v25: v23 architecture + dedicated soma_probe training phase after main training.
  Key insight: soma_probe was in optimizer params but NEVER called during training,
  so its weights only drifted via weight_decay → T22 was lottery (0% or 100%).

  Changes from v23:
  1. Add dedicated soma_probe training (50 batches, DVFS cycling, supervised)
  2. All v23 test mechanics preserved (T7b, frozen gate, T26a, scoring)

  v23 scored 26-28/40. T22 was bimodal. v25 target: stabilize T22 → 29-30/40.
...
Hardware setup:
  ...
  sudo HSA_OVERRIDE_GFX_VERSION=11.0.0 PYTORCH_ROCM_ARCH=gfx1100 \\
    venv/bin/python -u scripts/z2133_probe_train_v25.py
"""
...
def score_tests(phase_a, phase_b, baseline_ppl):
    ...
    if phase_b:
        ...
        add('T38', 'Disable-Writes Abl', 'PASS' if dma.get('kl_ratio', 1) > 1.03 else 'FAIL',
            f'kl_ratio={dma.get("kl_ratio", 1):.4f}', '>1.03')
...
def main():
    ...
    print("=" * 60)
    print("z2133v25: Probe Train — v23 Base + Dedicated SomaProbe Training")
    ...
    print(f"\n" + "=" * 60)
    print(f"z2133v25 Probe Train GPT-2 LM: {n_pass}/{n_total} PASS")
    print("=" * 60)

    # Save results
    out_path = os.path.join(os.path.dirname(__file__), '..', 'results', 'z2133_probe_train.json')
    out_path = os.path.abspath(out_path)
    result_obj = {
        'experiment': 'z2133v25_probe_train',
        'description': (
