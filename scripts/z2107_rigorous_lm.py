#!/usr/bin/env python3
"""
z2107: Rigorous Test Battery — Testrigor Fixes
=============================================================
Built on z2106 (Qwen3-8B NormBounded LoRA + Steering). Fixes test rigor issues:

  Fixes from testrigor analysis:
    ...
    if delta_low and delta_high:
        ...
        for d in range(dl.shape[1]):
            try:
                ...
                pass
        t6_pass = np.isfinite(max_t_d) and max_t_d > 3.0  # z2107: inf is NOT evidence
    else:
        max_t_d = 0
        t6_pass = False
...
def generation_sanity_check(model, test_data, kargs, tokenizer, phase_name=""):
    ...
    model.eval()
    model.body_encoder.reset_state()
    print(f"\n[z2107] Generation sanity check after {phase_name}...")
    try:
        with torch.no_grad():
...
def main():
    ...
    print("=" * 60)
    print("z2107: Rigorous Test Battery — Qwen3-8B NormBounded LoRA + Steering")
    ...
    # Save results
    out_path = '/home/ikaros/Documents/claude_hive/AMD_gfx1151_energy/results/z2107_rigorous_lm.json'
    final = {
        'experiment': 'z2107_rigorous_lm',
        'description': 'z2107: Rigorous test battery fixes — token-weighted PPL, T6/T10/T14/T37/T40 corrected, embodied-fixed gen mode',
        'key_changes': {
