#!/usr/bin/env python3
"""
z2131v23: Pure Rescore — v18 Base + Minimal Test Mechanics
==========================================================
v23: EXACT v18 architecture and training. Only changes:
...
Hardware setup:
  ...
  sudo HSA_OVERRIDE_GFX_VERSION=11.0.0 PYTORCH_ROCM_ARCH=gfx1100 \\
    venv/bin/python -u scripts/z2131_pure_rescore_v23.py
"""
...
def main():
    ...
    print("=" * 60)
    print("z2131v23: Pure Rescore — v18 Base + Minimal Test Mechanics")
    ...
    print(f"\n" + "=" * 60)
    print(f"z2131v23 Pure Rescore GPT-2 LM: {n_pass}/{n_total} PASS")
    print("=" * 60)

    # Save results
    out_path = os.path.join(os.path.dirname(__file__), '..', 'results', 'z2131_pure_rescore.json')
    out_path = os.path.abspath(out_path)
    result_obj = {
        'experiment': 'z2131v23_pure_rescore',
        'description': (
