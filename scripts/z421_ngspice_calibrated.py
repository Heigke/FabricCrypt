#!/usr/bin/env python3
"""z421: ngspice simulation with Mario's digitized Ipos PWL block.
...
OUT = REPO / "results" / "z421_ngspice_with_ipos"
DECKS = OUT / "decks"
...
# -------------------------- Deck builder --------------------------
DECK_TEMPLATE = """.title z421 ngspice with Ipos PWL ({HYP}: VG1={VG1:.3f}, VG2={VG2:.3f})
...
def main():
    ...
    for vg1 in (0.2, 0.4, 0.6):
        ...
        ax.set_title(f"z421 ngspice + Ipos PWL: VG1={vg1}V  "
