...
def main():
    ...
    # Save results
    out_path = '/home/ikaros/Documents/claude_hive/AMD_gfx1151_energy/results/z2103_deep_firmware_lm.json'
    final = {
        'experiment': 'z2103_deep_firmware_lm',
        'description': 'z2103: Deep Firmware LM — 8 stability fixes: SMN single-handle, freeze body state, skip agreement on ISA skip, EMA reset for T13, attribution grounding, checkpoint robustness',
        'key_changes': {
