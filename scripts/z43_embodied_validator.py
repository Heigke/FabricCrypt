#!/usr/bin/env python3
"""
FEEL z43: Complete Embodied Validator with Sensor Delta Reporting
=================================================================
...
2. COUNTERFACTUAL SWAP - Same prompt, swap sensor stream → policy changes
   NEW: Reports sensor delta to diagnose if stress is visible
...
Date: 2026-01-16 (z43 - Sensor Delta Reporting)
"""
...
class Z41Validator:
    ...
    def test_counterfactual_swap(self, trials: int = 10) -> Dict:
        ...
        # NEW: Average sensor delta across trials
        ...
        print(f"    Sensor delta (avg): {avg_sensor_delta:.4f}")  # NEW
        print(f"    PASSED: {passed}")

        # NEW: If sensor delta is too small, warn
        ...
        return {
            ...
            "sensor_delta": avg_sensor_delta,  # NEW
