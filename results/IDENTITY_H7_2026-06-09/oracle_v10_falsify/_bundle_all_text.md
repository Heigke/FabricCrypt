...
=== FILE: falsify_round1.json (2978 chars) ===
```json
{
  "ckpt_step": 1200,
  ...
  "B0_B1_B6": {
    "real_live": {
      "median": 25.953710492758034,
      "mean": 73.8552297485842,
      "min": 23.358967310908145,
      "max": 235.73998850581387,
      "n": 8
    },
    "knock": {
      "median": 34933.97357782225,
      "mean": 14133726.565065615,
      "min": 1339.1297195948907,
      "max": 43014561.47865615,
      "n": 8
    },
    "shuffle": {
      "median": 70.44849689759818,
      "mean": 75.45884875726293,
      "min": 46.525370613753985,
      "max": 122.87882551806925,
      "n": 8
    },
    "zero": 19.852276421008153,
    "daedalus_real_die": {
      "median": 1232.92817003295,
      "mean": 1348.2053794412313,
      "min": 756.1383581524383,
      "max": 2063.655278716746,
      "n": 8
    },
    "ikaros_heldout_replay": {
      "median": 24.962593836983185,
      "mean": 50.848282227490415,
      "min": 23.05773305276657,
      "max": 289.65089177583343,
      "n": 20
    },
    "gaussian_matched": {
      "median": 827.4173392707169,
      "mean": 1539.867807461727,
      "min": 129.1355018607028,
      "max": 4574.6113152540465,
      "n": 8
    }
  },
  "B2_static_vs_live": {
    "static_same_window": {
      "median": 66.42085353490822,
      "mean": 66.42085353490823,
      "min": 66.42085353490822,
      "max": 66.42085353490822,
      "n": 6
    },
    "live": {
      "median": 25.953710492758034,
  ...
  "B4_interp_real_to_knock": {
    "alpha_0.0": 84508544.4490897,
    "alpha_0.25": 15059408.510421857,
    "alpha_0.5": 156.41170490962466,
    "alpha_0.75": 90.58252817709392,
    "alpha_1.0": 66.42085353490822
  },
  "B5_channel_LOO": {
    "baseline_real": 66.42085353490822,
    "zeroed": {
      "ch0_zeroed": 448.7443812046556,
      "ch1_zeroed": 161.22299477827139,
      "ch2_zeroed": 86.94840224860944,
      "ch3_zeroed": 67.03120341867249,
      "ch4_zeroed": 18704703.672718894,
      "ch5_zeroed": 20.774855422265738,
      "ch6_zeroed": 118.96304340837487,
      "ch7_zeroed": 117.20042437071274,
      "ch8_zeroed": 641.2445223726706,
      "ch9_zeroed": 1469.7668730785458
    }
  },
  "B7_behavioral": {
    "out_div_real_vs_real_median": 0.31531912088394165,
    "out_div_real_vs_zero_median": 0.340730220079422,
    "interpretation": "if real-vs-real << real-vs-zero, coherent output is STABLE across live windows (gating, not graded real-time behavior)"
  },
  "B3_thermal_drift": {
    "T_hot": 96.0,
    "real_ppl_under_drift": {
      "median": 21.11099423693885,
      "mean": 21.092038241994715,
      "min": 20.99725826727403,
      "max": 21.11099423693885,
      "n": 6
    },
    "real_ppl_baseline": {
      "median": 25.953710492758034,
...
=== FILE: falsify_round2.json (800 chars) ===
```json
{
  "ppl_base": 19.848229988887006,
  "ik_real": 23.97707533606708,
  "daed_real": 1352.2089722529922,
  "G1_ikaros_daedalus_interp": {
    "1.0": 24.20113859730509,
    "0.875": 31.178892918184836,
    "0.75": 1161.1931571147347,
    "0.625": 3486.685961164125,
    "0.5": 3597.831438999059,
    "0.375": 2074.1046055650004,
    "0.25": 1626.464611385023,
    "0.125": 1367.5727574375096,
    "0.0": 1170.1420778866905
  },
  "G2_dc_only": {
    "median": 2187815.2046470204,
    "vs_real": 91246.12464123341
  },
  "G3_var_scale": {
    "0.0": 5264940.273514771,
    "0.25": 59.08223151857865,
    "0.5": 45.20424039505237,
    "1.0": 24.20766371802639,
    "2.0": 70.3860305689716,
    "4.0": 57.464004125176984
  },
  "G4": {
    "real": 23.97707533606708,
    "dc_only": 2187815.2046470204
  }
}
```


=== FILE: h7_embodied_v10.py (17262 chars) ===
```python
...
OUT = ROOT / "results/IDENTITY_EMBODIED_V10_2026-06-10"
OUT.mkdir(parents=True, exist_ok=True)
LOG = OUT / f"v10_{HOST}.jsonl"
CKPT = OUT / f"v10_{HOST}.pt"
BEST_CKPT = OUT / f"v10_best_{HOST}.pt"
...
def main():
    ...
    print(f"[v10 FiLM+temporal-sep] host={HOST} device={device} steps={args.steps} M_dep={M_DEP} cap={DEP_CAP}")
    ...
    for step in range(args.steps):
        ...
        dep_loss = (dep_term(nll_knock) + dep_term(nll_shuf)) / 2.0
        ...
        em_kl = 0.5 * (sym_kl(last_r.detach(), last_k).mean()
        ...
        if step > 0 and step % EVAL_EVERY == 0:
            ...
            blob = {"step": step, "host": HOST, "version": "v10",
